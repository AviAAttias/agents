package com.example.agents.reconciliationworker.entity;
...
@Entity
@Table(name = "validation_artifact", uniqueConstraints = {
        @UniqueConstraint(name = "uk_validation_artifact_job_task", columnNames = {"job_id", "task_type"})
})
@Getter
@Setter
